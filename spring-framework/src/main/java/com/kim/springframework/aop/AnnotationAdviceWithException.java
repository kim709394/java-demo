...
public class AnnotationAdviceWithException {
     ...
     * 前置增强
     * */
    @Before(value="throwExceptionHandlePointcut()")
    public void before(JoinPoint joinPoint){
        System.out.println("前置增强:"+joinPoint.getArgs());
     ...
     * 不管方法是否抛异常都执行
     */
    @After(value="throwExceptionHandlePointcut()")
     ...
     * rtn是定义传入的返回值参数
     */
    @AfterReturning(value="throwExceptionHandlePointcut()",returning = "rtn")
     ...
     */
    @Around("throwExceptionHandlePointcut()")
     ...
     * ex是定义传入的异常对象
     */
    @AfterThrowing(value="throwExceptionHandlePointcut()",throwing = "ex")
